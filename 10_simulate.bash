...
set -euxo pipefail
{
    ...
    Rscript \
        ...
        $OUTS/simulations/numCells2000_medUmi100_snr4_endo75_varyNumGuides

    # 2k cells, low-gRNA regime, varying number of guides
    Rscript \
        simulate/simulate_numCells2000_medUmi20_snr1_endo25_varyNumGuides.R \
        $OUTS/simulations/numCells2000_medUmi20_snr1_endo25_varyNumGuides
    ...
    Rscript \
        ...
        $OUTS/simulations/numCells2000_numGuides100_varyMOI
}
